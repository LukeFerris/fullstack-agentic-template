...
resource "aws_cloudfront_origin_access_control" "admin" {
  ...
  description                       = "OAC for Mission Control frontend S3 bucket"
...
resource "aws_cloudfront_distribution" "admin" {
  ...
  comment             = "Mission Control frontend"
  ...
  # SPA fallback: return index.html for missing keys and client-side routes
